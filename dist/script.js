...
/* harmony import */ var _modules_form_form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/form/form */ "./src/js/modules/form/form.js");
...
/* harmony import */ var _modules_donwload__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/donwload */ "./src/js/modules/donwload.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  slider.render();
  var sliderModules = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    btns: '.next',
    container: '.moduleapp'
  });
  sliderModules.render();
  var prevNext = new _modules_slider_slider_mainPrevNext__WEBPACK_IMPORTED_MODULE_7__["default"]('.prevmodule', '.nextmodule', '.moduleapp');
  prevNext.init();
  ...
  feedSlider.init();
  var differenceTenAgo = new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officer__card-item', '.plus');
  differenceTenAgo.init();
  var differenceToday = new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officernew', '.officer__card-item', '.plus');
  differenceToday.init();
  var player = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_1__["default"]('.showup .play', '.overlay');
  player.init();
  var playerModulePage = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_1__["default"]('.module__video-item .play', '.overlay');
  playerModulePage.init();
  var forms = new _modules_form_form__WEBPACK_IMPORTED_MODULE_4__["default"]('form');
  forms.init();
  var emailInputsChecked = new _modules_form_checkInputCyrilic__WEBPACK_IMPORTED_MODULE_5__["default"]('input[type="email"]');
  ...
  new _modules_donwload__WEBPACK_IMPORTED_MODULE_9__["default"]('.download').init();
});
...
/*#__PURE__*/
function () {
  function Differnce(container, items, trigger) {
  ...
  _createClass(Differnce, [{
    ...
    value: function showItem() {
      ...
      var _loop = function _loop(i) {
        if (_this.items[i].contains(_this.trigger)) {
          var counter = 0;

          _this.trigger.addEventListener('click', function () {
            _this.items[counter].classList.add('animate__animated', 'animate__fadeIn');

            _this.items[counter].style.display = 'flex';

            if (_this.items[counter] == _this.items[_this.items.length - 2]) {
              _this.items[i].classList.add('animate__animated', 'animate__fadeOut');
            }

            if (_this.items[counter] != _this.items[i]) {
              counter++;
            }
          });
        } else {
...
function () {
  ...
  _createClass(Download, [{
    key: "donwloadItem",
    value: function donwloadItem(path) {
...
/***/ "./src/js/modules/form/checkInputCyrilic.js":
/*!**************************************************!*\
  !*** ./src/js/modules/form/checkInputCyrilic.js ***!
  \**************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CheckInputCyrilic; });
...
var CheckInputCyrilic =
/*#__PURE__*/
function () {
  function CheckInputCyrilic(inputs) {
    _classCallCheck(this, CheckInputCyrilic);

    this.inputs = document.querySelectorAll(inputs);
  }

  _createClass(CheckInputCyrilic, [{
    key: "check",
    ...
    value: function init() {
      ...
      this.form.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          var api = _this.path.question;

          _this.postData(api, formData).then(function (res) {
...
/***/ "./src/js/modules/form/numberMask.js":
/*!*******************************************!*\
  !*** ./src/js/modules/form/numberMask.js ***!
  \*******************************************/
/*! exports provided: default */
...
/***/ "./src/js/modules/slider/slider-mainPrevNext.js":
/*!******************************************************!*\
  !*** ./src/js/modules/slider/slider-mainPrevNext.js ***!
  \******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MainPrevNext; });
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.description */ "./node_modules/core-js/modules/es.symbol.description.js");
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator */ "./node_modules/core-js/modules/web.dom-collections.iterator.js");
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _slider_main__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./slider-main */ "./src/js/modules/slider/slider-main.js");
...
function (_MainSlider) {
  _inherits(MainPrevNext, _MainSlider);

  function MainPrevNext(prev, next) {
    var _this;

    _classCallCheck(this, MainPrevNext);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MainPrevNext).call(this));
    _this.prev = prev;
    _this.next = next;
    return _this;
  }

  _createClass(MainPrevNext, [{
    key: "init",
    value: function init() {
      var _this2 = this;

      if (this.container) {
        document.querySelectorAll(this.prev).forEach(function (item) {
        ...
        document.querySelectorAll(this.next).forEach(function (item) {
          item.addEventListener('click', function (e) {
            e.stopPropagation();
            e.preventDefault();
  ...
  return MainPrevNext;
}(_slider_main__WEBPACK_IMPORTED_MODULE_9__["default"]);
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function decorizeSlides() {
      ...
      this.slides.forEach(function (slide) {
        slide.classList.remove("".concat(_this.activeClass));
    ...
    value: function bindTriggers() {
      ...
      this.next.addEventListener('click', function () {
        if (buttonsInSlider) {
          _this2.slides[_this2.slides.length - 2].before(_this2.slides[0]);
        } else {
      ...
      this.prev.addEventListener('click', function () {
        ...
        _this2.container.prepend(active);
